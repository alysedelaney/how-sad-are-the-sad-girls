...
This project aims to debunk the "Sad Girl Indie Music" trope through data.<br>Read more about the project [here]() and view the visualization [here](https://public.tableau.com/views/HowSadAretheSadGirls/Dashboard2?:language=en-US&:display_count=n&:origin=viz_share_link). 
